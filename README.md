...
| الأمر | الوصف |
|-------|-------|
| `/صلاة` | عرض أوقات الصلاة |
| `/صلاة city:Dubai country:AE` | أوقات الصلاة لمدينة محددة |
| `/أذان` | الصلاة القادمة والوقت المتبقي |
| `/هجري` | التاريخ الهجري |
| `/أذكار-الصباح` | أذكار الصباح |
| `/أذكار-المساء` | أذكار المساء |
| `/أذكار-النوم` | أذكار النوم |
| `/آية` | آية قرآنية عشوائية |
| `/سورة-آية surah:1 ayah:1` | آية محددة |
| `/حديث` | حديث شريف عشوائي |
| `/دعاء` | دعاء عشوائي |
| `/تفعيل-التنبيهات` | تفعيل تنبيهات الصلاة في القناة |
| `/إيقاف-التنبيهات` | إيقاف التنبيهات |
| `/تفعيل-الأذكار` | تفعيل إرسال الأذكار تلقائياً |
| `/إيقاف-الأذكار` | إيقاف الأذكار التلقائية |
| `/مناسبات` | عرض المناسبات الإسلامية القادمة |
